...
Phase 0: Conceptual Design
    → Invoke `platonic-brainstorming` (if installed) OR use bundled interactive method
...
| Phase | Skill / Action |
|-------|----------------|
| 0 | **`platonic-brainstorming`** (if installed) — structured design exploration, or use bundled interactive method |
